...
const submitMadLibs = (event) => {
	...
	const story = `
	<h3>Read your prophecy ... if you dare!</h3> <p>Once upon a time, there was a <span class="inserted-text">${userSubmission.person/animal/creature1}</span> named <span class="inserted-text">${userSubmission.yourName}</span> who lived in
